...
func Migrate(ctx context.Context, databaseURL string) error {
	...
	if !has00001 {
		...
		if _, err := tx.Exec(ctx, `INSERT INTO schema_migrations (version) VALUES ('00001'), ('00002'), ('00003'), ('00004'), ('00005'), ('00006'), ('00007'), ('00008'), ('00009'), ('00010')`); err != nil {
	...
	return applyMigration(ctx, pool, "00010", "migrations/00010_account_profile.sql")
}
